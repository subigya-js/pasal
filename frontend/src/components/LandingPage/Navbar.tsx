    ...
    return (
        <div className='relative'>
            <div className='px-4 md:px-10 flex items-center justify-between shadow-md h-[10vh] w-full'>
                ...
                {/* Middle - Hidden on mobile, visible on medium screens and up */}
                ...
                {/* Right - Hidden on mobile, visible on medium screens and up */}
            ...
            {/* Mobile menu */}
            <div className={`fixed top-0 left-0 w-64 h-full bg-white shadow-md transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:hidden`}>
                <div className='p-4'>
                    ...
                    <div className='mt-6 space-y-4'>
                        {/* Search input shown above "Search" icon */}
                        <input
                            type="text"
                            placeholder="Search"
